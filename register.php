<?php
	...
	if (!empty($_POST)){
		...
		elseif(strlen($email) > 100){
			...
			//email est déjà présent dans la base ?
		...
		//contient uniquement des lettres, des chiffres et des tirets et underscores
		elseif(!preg_match($usernameRegexp, $username)){
			$error = "Votre pseudo doit comporter uniquement des lettres, chiffres, tirets et underscores";
		...
		//en d'autre termes, si notre variable est encore vierge
		if (empty($error)){
...
<body>
	...
	<form method="POST" id="login_form">
		...
		<div>
			<label for="password_confirm">Répétez votre mot de passe !</label>
